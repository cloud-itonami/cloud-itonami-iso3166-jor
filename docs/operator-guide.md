...
2. Register the client's intake: business type, target public function,
   prior filing history in Jordan if any.
3. Run the advisor in read-only mode against JONEPS and the Government
   Tenders Directorate (GTD) channels.
4. Compare the checklist against the client's current documentation
   (Companies Control Department registration status).
...
- named referral relationship with Jordanian-licensed counsel or a
...
a working referral relationship with Jordanian-licensed counsel or a
registered agent for whatever licensed representation the law of
Jordan requires for actual public-procurement filings.
