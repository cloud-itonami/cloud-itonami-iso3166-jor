# cloud-itonami-iso3166-jor

Open ISO 3166 Blueprint for **JOR**: Jordan.
...
tax registration, and local-content rules in Jordan, so the operator
...
- **Not the government of Jordan.** See
...
- **Not legal or tax advice.** Every regulatory claim must cite the
  official source and route final filings to Jordanian-licensed counsel
...
(ISO 3166 `JOR`). Required capabilities:
