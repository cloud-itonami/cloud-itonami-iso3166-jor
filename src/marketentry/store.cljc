(ns marketentry.store
  "SSoT for the JOR market-entry compliance actor, behind a `Store`
...
(defn demo-data
  ...
  []
  {:engagements
   {"eng-1" {:id "eng-1" :operator "Kita Systems JO" :portal "GTD e-procurement"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-jo-entity? true :has-jo-entity? true
             :requires-ccd? true :ccd-verified? true
             :drafted? false :submitted? false
             :jurisdiction "JOR" :status :intake}
    "eng-2" {:id "eng-2" :operator "Atlantis LLC" :portal "GTD e-procurement"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-jo-entity? true :has-jo-entity? true
             :requires-ccd? true :ccd-verified? true
    ...
    "eng-3" {:id "eng-3" :operator "Minami Systems" :portal "GTD e-procurement"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             ...
             :drafted? false :submitted? false
             :jurisdiction "JOR" :status :intake}
    "eng-4" {:id "eng-4" :operator "Higashi Export" :portal "GTD e-procurement"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-jo-entity? true :has-jo-entity? false
             :requires-ccd? true :ccd-verified? true
             :drafted? false :submitted? false
             :jurisdiction "JOR" :status :intake}
    "eng-5" {:id "eng-5" :operator "Nishi Logistics" :portal "GTD e-procurement"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-jo-entity? true :has-jo-entity? true
             :requires-ccd? true :ccd-verified? false
             :drafted? false :submitted? false
             :jurisdiction "JOR" :status :intake}
    "eng-6" {:id "eng-6" :operator "Chuo Civic Tech" :portal "GTD e-procurement"
...
(defn- engagement->tx [{:keys [id operator portal base-fee monthly-rate monitoring-months claimed-fee
                               requires-jo-entity? has-jo-entity?
                               requires-ccd? ccd-verified?
                               drafted? submitted?
  ...
  (cond-> {:engagement/id id}
    ...
    (some? requires-jo-entity?)  (assoc :engagement/requires-jo-entity? requires-jo-entity?)
    (some? has-jo-entity?)       (assoc :engagement/has-jo-entity? has-jo-entity?)
    (some? requires-ccd?)    (assoc :engagement/requires-ccd? requires-ccd?)
    (some? ccd-verified?)    (assoc :engagement/ccd-verified? ccd-verified?)
...
(def ^:private engagement-pull
  [:engagement/id :engagement/operator :engagement/portal :engagement/base-fee :engagement/monthly-rate
   ...
   :engagement/requires-jo-entity? :engagement/has-jo-entity?
   :engagement/requires-ccd? :engagement/ccd-verified?
...
(defn- pull->engagement [m]
  (when (:engagement/id m)
    {:id (:engagement/id m) :operator (:engagement/operator m) :portal (:engagement/portal m)
     ...
     :requires-jo-entity? (boolean (:engagement/requires-jo-entity? m))
     :has-jo-entity? (boolean (:engagement/has-jo-entity? m))
     :requires-ccd? (boolean (:engagement/requires-ccd? m))
     :ccd-verified? (boolean (:engagement/ccd-verified? m))
