...
`cloud-itonami-iso3166-jor` is an OSS open-business blueprint. Governance covers both code and
the operator model.
...
Jordanian-licensed counsel or a registered agent for whatever licensed
representation the law of Jordan requires for public-procurement
filings.
